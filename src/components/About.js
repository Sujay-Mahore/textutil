...
export default function About() {
    ...
    const toggleStyle = ()=>
    {
        if(myStyle.backgroundColor ==='white')
        {
           ...
           setToggleButton("btn btn-dark ")
        }
    }
    const [toggleButton,setToggleButton] = useState("btn btn-dark ")
  ...
  return (
    <div className="container" style = {myStyle}>
      ...
      <button onClick={toggleStyle} type="button" className={toggleButton}> {btntext}</button>
      </div>
    </div>
  );
}
